...
accountRouter.delete('/users/:id/delete', checkAccessUsersMiddleware, deleteUser)
...
accountRouter.patch('/users/update-user-status', checkAccessUsersMiddleware, updateUserStatus);
